Страница интернет-магазина (--> [мой результат]())
===
...
![Внешний вид страницы после реализации компонента](https://github.com/netology-code/ra16-homeworks/blob/master/components/store-func/res/preview.png)
